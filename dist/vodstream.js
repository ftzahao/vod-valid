// --- 源 ---
const RESOURCE_SITES = `飘花电影,http://www.zzrhgg.com/api.php/provide/vod
唐人街,http://tangrenjie.tv/api.php/provide/vod/at/xm
唐人街,http://tangrenjie.tv/api.php/provide/vod
网民电影,http://prinevillesda.org/api.php/provide/vod
金鹰资源,http://jyzyapi.com/provide/vod/from/jinyingm3u8
酷点资源,http://api.kuapi.cc/api.php/provide/vod
闪电资源,http://sdzyapi.com/api.php/provide/vod/
闪电资源,http://sdzyapi.com/api.php/provide/vod
鲸鱼资源,https://jyzyapi.com/provide/vod/
樱花资源网,http://m3u8.apiyhzy.com/api.php/provide/vod
閃電資源,http://sdzyapi.com/api.php/provide/vod/from/sdm3u8
艾旦影视,http://lovedan.net/api.php/provide/vod
无尽资源,https://api.wujinapi.com/api.php/provide/vod/
黑木耳资源,https://www.heimuer.tv/api.php/provide/vod
...
紅牛资源,https://hongniuzy2.com/api.php/provide/vod/from/hnm3u8
最大资源,https://zuidazy.me/api.php/provide/vod/
...
WidgetMetadata = {
  id: 'vod_stream_source',
  title: '视频点播源',
  icon: null,
  version: '2.0.0',
  requiredVersion: '0.0.1',
  description: '获取VOD播放资源',
  author: 'ftzahao',
  site: 'https://github.com/ftzahao/vod-valid',
  globalParams: [
    {
      name: 'multiSource',
      title: '是否启用聚合搜索',
  ...
  try {
    ...
    if (trimmed.startsWith('[') || trimmed.startsWith('{')) {
      return JSON.parse(trimmed)
        .map((s) => ({ title: s.title || s.name, value: s.url || s.value }))
